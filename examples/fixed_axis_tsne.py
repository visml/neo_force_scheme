...
# # from sklearn.manifold import TSNE as TSNE_origin
# #
# # from neo_force_scheme.neo_force_scheme import TSNE
# #
# # #################################
# # projection_n_dimensions = 3
# # fix_column_to_z_projection_axis = 1
# # n_iter = 300
# # tsne = TSNE(n_components=projection_n_dimensions, fix_column_to_z_projection_axis=fix_column_to_z_projection_axis, n_iter=n_iter)
# # # tsne = TSNE_origin(n_components=projection_n_dimensions)
# # plot = True
# #
...
# # start = timer()
# # projection = tsne.fit_transform(X=data)
...
from neo_force_scheme.neo_force_scheme import NeoForceScheme, ProjectionMode, TSNE

#################################
projection_n_dimensions = 3
tsne = TSNE(verbose=True, learning_rate0=0.5,
...
# execute force scheme
start = timer()
projection = tsne.tsne(x=x, no_dims=3, perplexity=30.0, max_iter=100,
             fix_column_to_z_projection_axis=fix_column_to_z_projection_axis,
             drop_columns_from_dataset=drop_columns_from_dataset)
...
# calculate stress
stress = tsne.score(data, projection, drop_columns_from_dataset)
print('Kruskal stress {0}:'.format(stress))
